...
var levelUp = new Audio("assets/Level-up.mp3");
var minusLife = new Audio("assets/Minus-heart.mp3");
...
function checkCollision(snakes) {
  ...
  if (lv >= 2) {
    for (let i = 0; i < wall1.position.x.length; i++) {
      if (
        snakes.head.x == wall1.position.x[i] &&
        snakes.head.y == wall1.position.y[i]
      ) {
        isCollide = true;
      }
    }
  ...
  if (lv >= 3) {
    for (let i = 0; i < wall2.position.x.length; i++) {
      if (
        snakes.head.x == wall2.position.x[i] &&
        snakes.head.y == wall2.position.y[i]
      ) {
        isCollide = true;
      }
    }
  ...
  if (lv >= 4) {
    for (let i = 0; i < wall3.position.x.length; i++) {
      if (
        snakes.head.x == wall3.position.x[i] &&
        snakes.head.y == wall3.position.y[i]
      ) {
        isCollide = true;
      }
    }
  ...
  if (lv >= 5) {
    for (let i = 0; i < wall4.position.x.length; i++) {
      if (
        snakes.head.x == wall4.position.x[i] &&
        snakes.head.y == wall4.position.y[i]
      ) {
        isCollide = true;
      }
    }
